...
interface AddCourtProps {
  isOpen: boolean;
  onClose: () => void;
  onAddCourt: (court: Omit<Court["court"], "id">, availability: Court["availability"]) => Promise<void>;
...
const AddCourt: React.FC<AddCourtProps> = ({
  ...
  const [formData, setFormData] = useState<{
    ...
    court: {
      ...
      description: "",
      active: true,
      courtType: COURT_TYPES.PADEL,
      environment: COURT_ENVIRONMENT.INDOOR,
      slotDuration: 1.5,
    },
    availability: {
      monday: { periods: [{ startTime: "09:00", endTime: "22:00", id: "m1" }], available: true },
      tuesday: { periods: [{ startTime: "09:00", endTime: "22:00", id: "t1" }], available: true },
      wednesday: { periods: [{ startTime: "09:00", endTime: "22:00", id: "w1" }], available: true },
      thursday: { periods: [{ startTime: "09:00", endTime: "22:00", id: "th1" }], available: true },
      friday: { periods: [{ startTime: "09:00", endTime: "22:00", id: "f1" }], available: true },
      saturday: { periods: [{ startTime: "09:00", endTime: "22:00", id: "s1" }], available: true },
      sunday: { periods: [{ startTime: "09:00", endTime: "22:00", id: "su1" }], available: true },
    },
  });
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.court.name.trim()) {
      ...
      existingCourts.some(
        (c) => c.name.toLowerCase() === formData.court.name.toLowerCase(),
      )
    ) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      try {
        ...
        await onAddCourt(formData.court, formData.availability);
        resetForm();
        onClose();
      } catch (error) {
    ...
    >
      ...
      >
        <div className="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3">
          <h5 className="mb-0 fw-bold">Προσθήκη Νέου Γηπέδου</h5>
          <button
            className="btn-close"
            onClick={handleClose}
            type="button"
        ...
        <form onSubmit={handleSubmit} className="d-flex flex-column" style={{ flex: 1, overflow: "hidden" }}>
              ...
              <div>
                <div className="row g-3">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        setFormData({
                          ...
                          court: {
                            ...formData.court,
                            courtType: e.target.value as typeof formData.court.courtType,
                          },
                        });
                      }}
                      required
                  ...
                  <div className="col-md-6">
                    ...
                    <small className="form-text text-muted">
                      Τιμή για μια κράτηση {formData.court.slotDuration} ωρών
                    </small>
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <select
                      className="form-select"
                      value={formData.court.slotDuration}
                      onChange={(e) => {
                        setFormData({
                          ...formData,
                          court: {
                          ...
                          <div className="card-header bg-light d-flex justify-content-between align-items-center py-2">
                            ...
                            <div className="form-check form-switch mb-0">
                              <input
                                ...
                                disabled={isSubmitting}
                              />
                              <label className="form-check-label small" htmlFor={`available-${day}`}>
          ...
          <div className="card-footer bg-white border-top d-flex justify-content-end gap-2 py-3">
            ...
            <button
              ...
              disabled={isSubmitting}
            >
              {isSubmitting ? "Προσθήκη..." : "Προσθηκη Γηπεδου"}
            </button>
          </div>
        </form>
      </div>
